...
const websequencediagrams_1 = __importDefault(__nccwpck_require__(2510));
function render(folder, style) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (filename of diagramFiles) {
            ...
            core.debug(`Full path of file is ${path_1.default.join(folder, filename)}`);
            const graph = yield fs_1.promises.readFile(path_1.default.join(folder, filename));
            const diagram = (yield websequencediagrams_1.default.diagram(graph, style, 'png'))[0];
            yield fs_1.promises.writeFile(path_1.default.join(folder, filename.replace('.wsq', '.png')), diagram);
        }
    });
}
...
const diagrams_1 = __nccwpck_require__(5826);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const folder = core.getInput('folder');
            const style = core.getInput('style');
            const commitChanges = core.getBooleanInput('commitChanges');
            yield (0, diagrams_1.render)(folder, style);
            if (commitChanges) {
                // call gh to commit and push any changed files
                yield (0, github_1.commitFiles)();
            }
        }
        catch (error) {
